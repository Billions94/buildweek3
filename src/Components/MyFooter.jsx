...
import linkedinlogo from "public/assets/LI-Logo.png"
            ...
            <Col md={6}>
              <Row>
                <Col className="p-0" xs={6}>
                  <Col
                    className="pl-0 d-flex text-left align-items-center"
                    xs={12}
                  >
                    <i class=" footer-icon bi bi-question-circle-fill"></i>
                    <div className="pl-1">
                      <a className="footer-settings">Questions?</a>
                      <p className="footer-settings-small">
                  ...
                  <Col
                    ...
                    xs={12}
                  >
                    <i class="footer-icon bi bi-gear-fill"></i>
                    <div className="pl-1">
                      <a className="footer-settings">
                ...
                {/*Language Select*/}
                <Col xs={6}>
                  <p className="mb-0 footer-settings-small" >Select language</p>
